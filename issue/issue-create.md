...
## 手順
 ...
 ### パターンA（小規模・バグ修正）
             ...
             **テンプレート**: @.opencode/commands/issue/templates/bug_report.md
             ...
             4. [期待動作]
             5. [実際の動作]（オプション）
             6. [Screenshots/Videos]（オプション）
             7. [Additional Context]（オプション）
             
             > **必須項目**: Description, Steps to Reproduce, Expected Behavior
             > **オプション**: Actual Behavior, Screenshots/Videos, Additional Context
             ...
             **テンプレート**: @.opencode/commands/issue/templates/feature_request.md
