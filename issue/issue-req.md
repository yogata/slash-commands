...
6. **仕様書・ADRの更新（ユーザー承認後）**
   ...
   **テンプレートファイル**:
   - HLD: `docs/template/specifications.md` を参照
   - ADR: `docs/template/adr.md` を参照
...
**出力形式**: @.opencode/commands/issue/templates/comment_analysis.md

> ✅ パターンA（小規模）と判定しました。docs/の更新がありません。
> 次のステップ: `/issue-create` を使用してIssueに登録しますか？

### パターンB

**出力形式**: @.opencode/commands/issue/templates/comment_technical.md
