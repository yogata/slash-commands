...
| ファイル                         | 用途                               |
| -------------------------------- | ---------------------------------- |
| `bug_report.md`                  | バグ報告Issue本文（パターンA）      |
| `feature_request.md`             | 機能リクエストIssue本文（パターンB）|
| `comment_analysis.md`            | 分析結果コメント（パターンA）       |
| `comment_technical.md`           | 技術検討コメント（パターンB）       |
| `comment_fix.md`                 | 修正指示コメント（レビューNG時）    |
| `comment_record.md`              | 対応記録コメント（パターンA）       |
| `comment_implementation.md`      | 実装記録コメント（パターンB）       |
| `pr_body.md`                     | PR本文テンプレート                  |
